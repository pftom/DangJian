...
export const initialAnswerState = {
  ...
  questions: [
    ...
    },
    {
      ...
      options: ["A. 民主制", "B. 集中制", "C. 民主集中制", "D. 民主协商制"],
      answer: "C"
    },
    {
      question:
        "4.中国共产党领导人民构建社会主义和谐社会。按照民主法治、公平正义、诚信友爱、充满活力、安定有序、人与自然和谐相处的总要求和共同建设、共同享有的原则，以（ ）为重点，解决好人民最关心、最直接、最现实的利益问题,努力形成全体人民各尽其能、各得其所而又和谐相处的局面。",
      options: ["A. 改善民生", "B. 发展经济", "C. 社会保障", "D. 扩大就业"],
      answer: "A"
    },
    {
      question:
        "5.我们党的最大政治优势是密切联系群众，党执政后的最大危险是（ ）。党风问题、党同人民群众联系问题是关系党生死存亡的问题。",
      options: ["A. 脱离群众", "B. 骄傲自满", "C. 形式主义", "D. 经验主义"],
      answer: "A"
    }
  ]
};
...
function answer(state = initialAnswerState, action) {
  switch (action.type) {
    case ANSWER_QUESTION: {
      const { everyDayNowQuestionIndex } = state;
      return {
        ...state,
    ...
    case ANSWER_QUESTION_SUCCESS: {
      const { everyDayAnswerCount, everyTermAnswerCount } = state;
      return {
        ...state,
